<?php require_once 'controllers/session_start.php';
      require_once 'controllers/upload-file.php';?>
        ...
        <div class="page-content-back">
            ...
            <div class="main-navigation">
              <div class="navigation">
                ...
                <ul>
                  ...
                  <li class="nav active"><a href="upload" class="back">Add posts</a></li>
          ...
          <div class="navigation mobile back">
            <ul>
              ...
              <li class="nav active"><a href="upload">Add posts</a></li>
    ...
    <div class="upload-container">
  		...
  		<div class="upload-headline">
  			<h2>Upload here your pictures from your trip!</h2>
  	</div>
  	<div class="form">
      <span class="form-text"><?= $error['feedback']; ?></span>
      <span class="form-text-success"><?= $success; ?></span>
      ...
      <div class="form-group">
        <label for="imagetext">Say something about your image...</label>
        <textarea class="form-control" id="text" cols="10" rows="10" name="image_text" min="0" maxlength="100" Placeholder="Write here your image text (max. 100 characters)..."></textarea>
     </div>
