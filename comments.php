<?php require_once 'controllers/session_start.php';
      require_once 'controllers/show-comments.php';  ?>
        ...
        <div class="page-content-back">
            ...
            <div class="main-navigation">
              <div class="navigation">
                ...
                <ul>
                  ...
                  <li class="nav active"><a href="comments" class="back">Comments</a></li>
          ...
          <div class="navigation mobile back">
            <ul>
              ...
              <li class="nav active"><a href="comments">Comments</a></li>
     ...
     <div class="users-container">
        <div class="users-content">
          <table class="table table-striped">
            ...
            <?php while ($comment_row = mysqli_fetch_assoc($result)): ?>
            <tbody>
              <tr>
                <td><?= $comment_row["id"]?></td>
                <td><?= $comment_row["user_id"] ?></td>
                <td><?= $comment_row["comment"] ?></td>
                <td><?= $comment_row["image"] ?></td>
                <td><?= $comment_row["posted_at"] ?></td>
                <td><a href="?delete_id=<?= $comment_row["id"]?>"><i class="fas fa-trash-alt"></i></a></td>
              </tr>
            </tbody>
          <?php endwhile ?>
          </table>
