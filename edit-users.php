<?php require_once 'controllers/session_start.php';
    ...
    <!--- MAIN CONTENT START --->
     ...
     <div class="edit-headline">
       ...
       <span class="form-text"> <?= $errors['update-fail'] ?> </span>
     </div>
                             ...
                             <div class="form-group">
                              ...
                              <div class="col-md-6">
                                <div class="form-group">
                                  ...
                                  <span class="form-text"><?=$errors['status']?> </span>
                                </div>
                              </div>
                            <?php else: ?>
                              <div class="col-md-6">
                              ...
                              <div class="col-md-6">
                                <div class="form-group">
                                  <label for="status">Status</label>
                                  <input type="text" name="status" class="form-control" value="<?=$user['status']?>" readonly>
                                </div>
                              </div>
                             <?php endif ?>
                               </div>
